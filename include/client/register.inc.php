...
?>
<h1><?php echo __('Registrar Conta'); ?></h1>
<p><?php echo __(
'Use os formul&aacuterios abaixo para criar ou atualizar as informa&ccedil&otildees que temos em arquivo para a sua conta'
); ?>
</p>
...
<tr>
    <td colspan=2">
        <div><hr><h3><?php echo __('Credenciais de acesso'); ?></h3></div>
    </td>
</tr>
<?php if ($info['backend']) { ?>
<tr>
    <td width="180">
        <?php echo __('Fazer login como'); ?>:
    </td>
    <td>
...
<tr>
    <td width="180">
        <?php echo __('Confirme sua nova senha'); ?>:
    </td>
    <td>
...
<script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/jstz.min.js?6bd7884"></script>
