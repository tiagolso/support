...
define('SECRET_SALT','74cCeUfzbrx9vi1sQE7yn7WMYYVQ=eW6');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','servidorpower10@gmail.com');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','172.106.0.118:3306');
define('DBNAME','ticket');
define('DBUSER','tiagoyear3');
define('DBPASS','nSASUsfrW.gVb8a');
